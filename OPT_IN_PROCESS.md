...
NRM is a private personal relationship-management tool. Prospective users request access by visiting the [NRM signup page](https://kristiananc.github.io/Network-Resource-Management-NRM-tool/signup/), providing their name and phone number, and checking a consent box agreeing to receive automated NRM text messages.

Submitted requests are reviewed individually by the account owner. A phone number is not authorized to use NRM unless the request has been manually reviewed and approved.
